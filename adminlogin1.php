...
<h3 class="text-center">Admin Login</h3 >
  <div class="form-group p-3">
    <label for="exampleInputEmail1" class="text-dark" ><b>Email address : </b></label>
    <input type="email" class="form-control" name="txt1" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" style="width:310px; margin-left:-20px;">
