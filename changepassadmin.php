...
<h3 class="text-center">Change Password</h3 >
  <div class="form-group ">
    ...
    <input type="email" class="form-control" name="txt1" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Insert Your Old Password" style="width:300px;">
    
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1" class="text-darke">&emsp;<b>New Password : </b></label>
    <input type="password" name="txt2" class="form-control" id="exampleInputPassword1" placeholder="Insert Your New Password">
  </div>
 
 <div class="form-group">
    <label for="exampleInputPassword1" class="text-darke">&emsp;<b>Confirm Password : </b></label>
    <input type="password" name="txt2" class="form-control" id="exampleInputPassword1" placeholder="Insert Your Confirm Password">
  </div>
